...
Filob is the tool which can process a huge file (.txt/XML) in a sync/Async mode automatically in just a minute and without putting any effort.
...
Filob requires few things from caller:
